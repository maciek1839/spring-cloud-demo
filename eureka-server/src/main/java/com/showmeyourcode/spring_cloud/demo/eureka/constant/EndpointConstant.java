package com.showmeyourcode.spring_cloud.demo.eureka.constant;
...
public class EndpointConstant {
    ...
    public static String ACTUATOR_MAPPINGS_ENDPOINT = "/actuator/mappings";
    public static String EUREKA_DASHBOARD_ENDPOINT = "/";
